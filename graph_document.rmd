...
```{r fig-combined_performance_graph_classification_auc, fig.cap="Predictive performance of classification models, AUC measure.", fig.width = 9}
...
```
```{r fig-combined_performance_graph_classification_acc, fig.cap="Predictive performance of classification models, accuracy measure.", fig.width = 9}
combined_performance %>% 
...
```{r fig-combined_performance_graph_classification_kap, fig.cap="Predictive performance of classification models, Cohen's Kappa measure.", fig.width = 9}
combined_performance %>% 
...
```{r fig-combined_performance_graph_classification_log_loss, fig.cap="Predictive performance of classification models, log loss.", fig.width = 9}
combined_performance %>% 
