...
```{r graph_combined_weights_all_models_all_terms, fig.cap="Terms related to 'DEMAGOGUE', average over all models, all terms."}
...
```{r graph_combined_weights_all_models_nouns, fig.cap="Terms related to 'DEMAGOGUE', average over all models, nouns only."}
graph_combined_weights[[2]]

```

```{r graph_combined_weights_all_models_verbs, fig.cap="Terms related to 'DEMAGOGUE', average over all models, verbs only.}
graph_combined_weights[[3]]

```

```{r graph_combined_weights_all_models_verbs, fig.cap="Terms related to 'DEMAGOGUE', average over all models, adjectives only.}
graph_combined_weights[[4]]

```


```{r graph_combined_weights_all_models_verbs, fig.cap="Terms related to 'DEMAGOGUE', average over all models, terms starting with caps only.}
