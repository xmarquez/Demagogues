...
#| fig-cap: Combined weights, isms only. Terms at the top are more closely associated with 'democracy' in later years. Label indicates the peak density of association.
#| fig-height: 9
graph[[5]]
```

```{r fig-graph_combined_weights_uppercase}
#| fig-cap: Combined weights, nouns starting with uppercase. Terms at the top are more closely associated with 'democracy' in later years. Label indicates the peak density of association.
#| fig-height: 9
graph[[6]]
```
