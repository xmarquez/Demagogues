...
```{r graph_combined_weights_all_models_adjectives, fig.cap="Terms related to 'DEMOCRACY', average over all models, adjectives only."}
graph_combined_weights[[4]]

```


```{r graph_combined_weights_all_models_ideologies, fig.cap="Terms related to 'DEMOCRACY', average over all models, terms ending in ism."}
...
```{r combined_performance_graph_regression, fig.cap="Predictive performance of regression models."}
combined_performance %>% 
